...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(87) ], __WEBPACK_AMD_DEFINE_RESULT__ = function() {}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	__webpack_require__(0),
	__webpack_require__(1),
	__webpack_require__(14) // appendTo
], __WEBPACK_AMD_DEFINE_RESULT__ = function( jQuery, document ) {
...
var testAlert = function testAlert(input) {
	alert(input);
};
...
function sendWorkAjax(sendUrl, param, type, trueCallback, errorCallback) {
	$.ajax({
		...
		error: function error(jqXHR, extStatus, errorThrown) {
...
function sendWorkAjaxToLogin(sendUrl, param, type, trueCallback, falseCallback, errorCallback) {
	$.ajax({
		type: type,
		url: sendUrl,
		contentType: "application/json;charset=UTF-8",
...
function sendWorkViaAjax(sendUrl, param, trueCallback, falseCallback, errorCallback) {
	$.ajax({
		type: "post",
		contentType: "application/json;charset=UTF-8",
		url: sendUrl,
...
var $id = (0, _jquery2.default)('#textId');

$id.text('hey babo ya');

alert('ddfdsad');
(0, _common2.default)('dani is crazy');
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	__webpack_require__(0),
	__webpack_require__(23),
	__webpack_require__(20) // Delay is optional because of this dependency
], __WEBPACK_AMD_DEFINE_RESULT__ = function( jQuery ) {
