...
<head>
  <meta charset="UTF-8">
  <title>Chart PieceLabel</title>
  <link href='https://fonts.googleapis.com/css?family=Roboto+Slab' rel='stylesheet' type='text/css'>
  <link rel="stylesheet" href="style.css">
  <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.4.0/Chart.bundle.min.js"></script>
  <script type="text/javascript" src="../../src/Chart.PieceLabel.js"></script>
  <script>
...
<body>
  <div id="header">
    <h1>Chart PieceLabel</h1>
    <a href="https://github.com/emn178/Chart.PieceLabel.js"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://github-camo.global.ssl.fastly.net/a6677b08c955af8400f44c6298f40e7d19cc5b2d/68747470733a2f2f73332e616d617a6f6e6177732e636f6d2f6769746875622f726962626f6e732f666f726b6d655f72696768745f677261795f3664366436642e706e67" alt="Fork me on GitHub" data-canonical-src="https://s3.amazonaws.com/github/ribbons/forkme_right_gray_6d6d6d.png"></a>
  </div>
  <div id="body">
    <div id="description">
      <p>
    ...
    <div class="charts">
      ...
      <div class="row">
        ...
        <div class="chart-wrapper">
          <canvas id="doughnut-canvas2"></canvas>
        </div>
        <div class="code">
          <pre class="brush: js">
            {
      ...
      <div class="row">
        ...
        <div class="chart-wrapper">
          <canvas id="doughnut-canvas3"></canvas>
        </div>
        <div class="code">
          <pre class="brush: js">
            {
      ...
      <div class="row">
        <div class="chart-wrapper">
          <canvas id="pie-canvas5"></canvas>
        </div>
        <div class="chart-wrapper">
          <canvas id="doughnut-canvas5"></canvas>
        </div>
        <div class="code">
          <pre class="brush: js">
            {
      ...
      <div class="row">
        <div class="chart-wrapper">
          <canvas id="pie-canvas6"></canvas>
        </div>
        <div class="chart-wrapper">
          <canvas id="doughnut-canvas6"></canvas>
        </div>
        <div class="code">
          <pre class="brush: js">
            {
      ...
      <div class="row">
        <div class="chart-wrapper">
          <canvas id="pie-canvas7"></canvas>
        </div>
        <div class="chart-wrapper">
          <canvas id="doughnut-canvas7"></canvas>
        </div>
        <div class="code">
          <pre class="brush: js">
            {
